...
<div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
    <img alt="background" id="background" class="absolute -left-20 top-0 max-w-[877px]"
                ...
                <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                    ...
                    <div
                        ...
                        <div
                            ...
                            {{ svg('fas-dice-d20', 'size-5 sm:size-6', ['style' => 'color: #FF2D20']) }}
                    ...
                    >
                        <div
                            class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                            {{ svg('fas-people-carry-box', 'size-5 sm:size-6', ['style' => 'color: #FF2D20']) }}
                    ...
                    <div
                        ...
                        <div
                            class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                            {{ svg('fas-hand-spock', 'size-5 sm:size-6', ['style' => 'color: #FF2D20']) }}
                        </div>
